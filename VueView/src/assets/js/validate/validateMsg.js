...
class ErrorBag{
  ...
  deleteErrors(name){
      ...
      if(index > -1 && index < this.fildes.length){
          this.filedds.splice(index, 1);
      }
  }
...
export class validateMsg {
    ...
    setErrors(name, msg, postion) {
        this.errors.setErrors(name, msg, postion);
    }
